...
fun App(
    ...
    Scaffold (
        ...
        NavHost(
            ...
            composable(AppScreens.Search.route) { Search(navController) }
            composable(AppScreens.EventsMap.route) { EventsMap(navController) }
            composable(AppScreens.EventsList.route) { EventsList(navController) }
            composable(AppScreens.Evento.route) { Evento(navController) }
